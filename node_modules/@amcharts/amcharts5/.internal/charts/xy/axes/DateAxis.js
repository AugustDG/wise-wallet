...
var DateAxis = /** @class */ (function (_super) {
            ...
            if (this.get("groupData") && !series.get("groupDataDisabled")) {
                ...
                $array.each(intervals_1, function (interval) {
                    ...
                    $array.each(dataItems_1, function (dataItem) {
                        ...
                        var roundedTime = $time.round(new Date(time), interval.timeUnit, interval.count, firstDay_1, utc_1, firstDate, timezone_1).getTime();
                        var dataContext;
        ...
        value: function () {
            ...
            if ($type.isNumber(min) && $type.isNumber(max)) {
                ...
                while (value < selectionMax + intervalDuration) {
                    ...
                    var endValue = value + $time.getDuration(gridInterval.timeUnit, gridInterval.count * this._getM(gridInterval.timeUnit));
    ...
    Object.defineProperty(DateAxis.prototype, "_fixMin", {
        ...
        value: function (min) {
            ...
            var startTime = $time.round(new Date(min), timeUnit, baseInterval.count, firstDay, utc, undefined, timezone).getTime();
            var endTime = startTime + $time.getDuration(timeUnit, baseInterval.count * this._getM(timeUnit));
    ...
    Object.defineProperty(DateAxis.prototype, "_fixMax", {
        ...
        value: function (max) {
            ...
            var utc = this._root.utc;
            var timeUnit = baseInterval.timeUnit;
            var startTime = $time.round(new Date(max), timeUnit, baseInterval.count, firstDay, utc, undefined, timezone).getTime();
            var endTime = startTime + $time.getDuration(timeUnit, baseInterval.count * this._getM(timeUnit));
            endTime = $time.round(new Date(endTime), timeUnit, 1, firstDay, utc, undefined, timezone).getTime();
            ...
            $array.each(fields, function (field) {
                ...
                if ($type.isNumber(value)) {
                    ...
                    if (value >= startTime && value <= endTime) {
                        ...
                        endTime = startTime + $time.getDuration(timeUnit, count * _this._getM(timeUnit));
                        endTime = $time.round(new Date(endTime), timeUnit, 1, firstDay, utc, undefined, timezone).getTime();
    ...
    Object.defineProperty(DateAxis.prototype, "roundAxisPosition", {
        ...
        value: function (position, location) {
            ...
            if (!$type.isNaN(value)) {
                ...
                var duration = $time.getDateIntervalDuration(baseInterval, new Date(value), firstDay, utc, timezone);
                if (timezone) {
