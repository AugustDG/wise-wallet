                    ...
                    if (axis_1.get("groupData")) {
                        ...
                        if (interval) {
                            ...
                            if (endTime != null) {
                                ...
                                end_1 = $time.round(new Date(endTime), interval.timeUnit, interval.count, firstDay, utc, undefined, timezone);
                                end_1.setTime(end_1.getTime() + $time.getDuration(interval.timeUnit, interval.count * 1.05));
                                end_1 = $time.round(end_1, interval.timeUnit, interval.count, firstDay, utc, undefined, timezone);
                            }
